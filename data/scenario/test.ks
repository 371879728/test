...
[preload storage="data/fgimage/fes/544.png"]
...
[cutin text="& ['タップして開始']"]
  ; 右上の半透明のやつ
  [image layer="2" zindex="100" storage="bg/r.png" x="0" y="0" time="10" wait="true"]
  ; キャラ表示
  [hyouji chara="migi"]
  [hyouji chara="hidari"]
...
[display_turn_start]
    ...
    [image layer="1" zindex="11" name="display,display_img" storage="fes/544.png" x="& 276+18" y="30" width="690" height="444" time="10" wait="true"]
[display_turn_end]
...
[chara_move name="migi" time="500" anim="true" wait="false" left="354" effect="easeInOutQuad"]
...
[glink  color="btn_26_red"  storage="scene1.ks"  size="24"  x="300"  width="600"   y="200"  text="応援スポンサーの登録を見てみる"  target="*yes"  ]
[glink  color="btn_26_black"  storage="scene1.ks"  size="24"  x="300"  width="600"   y="320"  text="今はいい"  target="*no"  ]
[s  ]
...
[glink  color="btn_26_red"  storage="scene1.ks"  size="24"  x="300"  width="600"   y="200"  text="怒った表情も素敵！"  target="*pose1"  ]
[glink  color="btn_26_red"  storage="scene1.ks"  size="24"  x="300"  width="600"   y="300"  text="笑顔をお願いします！"  target="*pose2"  ]
[glink  color="btn_26_red"  storage="scene1.ks"  size="24"  x="300"  width="600"   y="400"  text="面白い顔も見てみたい！"  target="*pose3"  ]
