...
[iscript]
  ...
  // ドット絵の解像度の都合で、画面は1278×720となっております。（1280にすると、ビミョーに歪んでしまいます）
  // だからといってゲーム画面幅を1278にすると色々と影響が出そうな気もするので、画面の右2pxは完全な黒を右2px、message1の上の方に敷くことで隠しております。
  $('#tyrano_base').append('<img class="black2px" src="./data/fgimage/bg_black2.png" style="position: absolute; right: 0px; top: 0px; width:2px; height:720px; z-index: 100000005; opacity: 1;">');
...
; 時間別の背景
[bg2 width="1278" height="720" storage="& f.version +'/'+ f.jikan + '.png' " time="10"]

; 柵&床画像
[image name="bgbase" layer="0" zindex="2" storage="& 'bg/base/'+f.version+'.png' " x="0" y="0" time="10" wait="true"]
